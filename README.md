...
| strict_except                       | List[String] |            | (Default: False) Validate records, including disallowing additional or missing properties not listed (even if the schema lacks such constraints).  Implies `validate_records`. |
